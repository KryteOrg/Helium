...
class Window(QMainWindow):
	...
	def initUI(self):
		...
		self.refresh.setStyleSheet("border-image: url('browser/refresh.png') 0 0 0 0 stretch stretch;")
		self.extension = QPushButton("", self)
		self.extension.resize(30,30)
		self.extension.move(150,0)
		self.extension.setStyleSheet("border-image: url('browser/extension.png') 0 0 0 0 stretch stretch;")
		self.cookie = QPushButton("", self)
		self.cookie.resize(30,30)
		self.cookie.move(240,0)
		self.cookie.setStyleSheet("border-image: url('browser/cookie.png') 0 0 0 0 stretch stretch;")
